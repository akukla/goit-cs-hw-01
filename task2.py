...
class Parser:
    ...
    def expr(self):
        """Парсер для 'expr' правил граматики. Обробляє додавання та віднімання."""
        node = self.term()
    ...
    def factor(self):
        """Парсер для 'factor' правил граматики. Обробляє числа та вирази в дужках."""
        token = self.current_token
...
def parse_expr(expr):
    ...
    return expr, interpreter.interpret()

if __name__ == "__main__":
    print(parse_expr("(2 + 3) * 4"))
